...
function index() {
  useEffect(() => {
    ...
    let smoother1 = ScrollSmoother.create({
      wrapper: "#sequirrel-wrapper",
      content: "#sequirrel-content",
      smooth: 1,
    });
  ...
  return (
    <div id="sequirrel-wrapper">
      <div id="sequirrel-content">
          ...
          <div className="individual-project-page-basic-info">
            ...
            <div className="project-info-entry">
              ...
              <div className="project-info-content">
                Vanilla CSS, React, React Flow, React, ReduxNode.js, Express,
